    ...
    public class Business_Rule_CreationController : Controller
    {
        ...
        public ActionResult Create(int Id = 0, int consult = 0, int ModuleId = 0)
        {
            ...
            if ((Id.GetType() == typeof(string) && Id.ToString() != "") || ((Id.GetType() == typeof(int) || Id.GetType() == typeof(Int16) || Id.GetType() == typeof(Int32) || Id.GetType() == typeof(Int64) || Id.GetType() == typeof(short)) && Id.ToString() != "0"))
            {
                ...
                varBusiness_Rule_Creation = new Business_Rule_CreationModel
                {
                    ...
                    ,
                    StatusDescription = CultureHelper.GetTraduction(Business_Rule_CreationData.Status_Spartan_BR_Status.StatusId.ToString(), "Spartan_BR_Status", Business_Rule_CreationData.Status_Spartan_BR_Status.Description, "Description") ?? (string)Business_Rule_CreationData.Status_Spartan_BR_Status.Description
                    ,
                    Complexity = Business_Rule_CreationData.Complexity
                    ,
                    ComplexityDescription = CultureHelper.GetTraduction(Business_Rule_CreationData.Complexity_Spartan_BR_Complexity.Key_Complexity.ToString(), "Spartan_BR_Complexity", Business_Rule_CreationData.Complexity_Spartan_BR_Complexity.Description, "Description") ?? (string)Business_Rule_CreationData.Complexity_Spartan_BR_Complexity.Description
            ...
            if (Spartan_BR_Statuss_Status != null && Spartan_BR_Statuss_Status.Resource != null)
                ...
                {
                    Text = CultureHelper.GetTraduction(Convert.ToString(m.StatusId), "Spartan_BR_Status", m.Description, "Description") ?? m.Description.ToString(),
            ...
            if (Spartan_BR_Complexitys_Complexity != null && Spartan_BR_Complexitys_Complexity.Resource != null)
                ...
                {
                    Text = CultureHelper.GetTraduction(Convert.ToString(m.Key_Complexity), "Spartan_BR_Complexity", m.Description, "Description") ?? m.Description.ToString(),
        ...
        public ActionResult GetSpartan_BR_History(int draw, int start, int length, string RelationId = "0")
        {
            ...
            ,
                    ...
                    Change_Type = m.Change_Type
                        ,
                    Change_TypeDescription = CultureHelper.GetTraduction(m.Change_Type_Spartan_BR_Type_History.Key_Type_History.ToString(), "Spartan_BR_Type_History", m.Change_Type_Spartan_BR_Type_History.Description, "Description") ?? (string)m.Change_Type_Spartan_BR_Type_History.Description
            ,
        ...
        public ActionResult GetSpartan_BR_History_Spartan_BR_Type_HistoryAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.Key_Type_History), "Spartan_BR_Type_History", item.Description, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_StatusAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.StatusId), "Spartan_BR_Status", item.Description, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_ComplexityAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.Key_Complexity), "Spartan_BR_Complexity", item.Description, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetBusiness_Rule_CreationList(int ObjectId, int Attribute, int sEcho, int iDisplayStart, int iDisplayLength, string where, string order)
        {
            ...
            return Json(new
            {
                ...
                ,
                    Documentation = m.Documentation
                            ,
                    StatusDescription = CultureHelper.GetTraduction(m.Status_Spartan_BR_Status.StatusId.ToString(), "Spartan_BR_Status",string.Empty, "Description") ?? (string)m.Status_Spartan_BR_Status.Description
                            ,
                    ComplexityDescription = CultureHelper.GetTraduction(m.Complexity_Spartan_BR_Complexity.Key_Complexity.ToString(), "Spartan_BR_Complexity",string.Empty, "Description") ?? (string)m.Complexity_Spartan_BR_Complexity.Description
        ...
        public ActionResult GetSpartan_BR_Conditions_Detail(int draw, int start, int length, string RelationId = "0")
        {
            ...
            ,
                    ...
                    Condition_Operator = m.Condition_Operator
                        ,
                    Condition_OperatorDescription = CultureHelper.GetTraduction(m.Condition_Operator_Spartan_BR_Condition_Operator.ConditionOperatorId.ToString(), "Spartan_BR_Condition_Operator", string.Empty, "Description") ?? (string)m.Condition_Operator_Spartan_BR_Condition_Operator.Description
            ,
            ...
            ,
                    ...
                    Condition = m.Condition
                        ,
                    ConditionDescription = CultureHelper.GetTraduction(m.Condition_Spartan_BR_Condition.ConditionId.ToString(), "Spartan_BR_Condition", string.Empty, "Description") ?? (string)m.Condition_Spartan_BR_Condition.Description
            ...
            var jsonResult = Json(new
            {
                data = result.Spartan_BR_Actions_True_Details.Select(m => new Spartan_BR_Actions_True_DetailGridModel
                {
                    ...
                    Action_Classification = m.Action_Classification
                        ,
                    Action_ClassificationDescription = CultureHelper.GetTraduction(m.Action_Classification_Spartan_BR_Action_Classification.ClassificationId.ToString(), "Spartan_BR_Action_Classification", string.Empty, "Description") ?? (string)m.Action_Classification_Spartan_BR_Action_Classification.Description
                        ,
                    Action = m.Action
                        ,
                    ActionDescription = CultureHelper.GetTraduction(m.Action_Spartan_BR_Action.ActionId.ToString(), "Spartan_BR_Action", string.Empty, "Description") ?? (string)m.Action_Spartan_BR_Action.Description
                        ,
                    Action_Result = m.Action_Result
                        ,
                    Action_ResultDescription = CultureHelper.GetTraduction(m.Action_Result_Spartan_BR_Action_Result.ActionResultId.ToString(), "Spartan_BR_Action_Result", string.Empty, "Description") ?? (string)m.Action_Result_Spartan_BR_Action_Result.Description
            ,
            ...
            var jsonResult = Json(new
            {
                data = result.Spartan_BR_Operation_Details.Select(m => new Spartan_BR_Operation_DetailGridModel
                {
                    ...
                    Operation = m.Operation
                        ,
                    OperationDescription = CultureHelper.GetTraduction(m.Operation_Spartan_BR_Operation.OperationId.ToString(), "Spartan_BR_Operation", string.Empty, "Description") ?? (string)m.Operation_Spartan_BR_Operation.Description
            ...
            var jsonResult = Json(new
            {
                data = result.Spartan_BR_Process_Event_Details.Select(m => new Spartan_BR_Process_Event_DetailGridModel
                {
                    ...
                    Process_Event = m.Process_Event
                        ,
                    Process_EventDescription = CultureHelper.GetTraduction(m.Process_Event_Spartan_BR_Process_Event.ProcessEventId.ToString(), "Spartan_BR_Process_Event", string.Empty, "Description") ?? (string)m.Process_Event_Spartan_BR_Process_Event.Description
        ...
        public ActionResult GetSpartan_BR_Peer_Review(int draw, int start, int length, string RelationId = "0")
        {
            ...
            ,
                    ...
                    Rejection_reason = m.Rejection_reason
                        ,
                    Rejection_reasonDescription = CultureHelper.GetTraduction(m.Rejection_reason_Spartan_BR_Rejection_Reason.Key_Rejection_Reason.ToString(), "Spartan_BR_Rejection_Reason", string.Empty, "Description") ?? (string)m.Rejection_reason_Spartan_BR_Rejection_Reason.Description
            ,
                    Comments = m.Comments
            ,
        ...
        public ActionResult GetSpartan_BR_Scope_Detail(int draw, int start, int length, string RelationId = "0")
        {
            ...
            var jsonResult = Json(new
            {
                data = result.Spartan_BR_Scope_Details.Select(m => new Spartan_BR_Scope_DetailGridModel
                {
                    ...
                    Scope = m.Scope
                        ,
                    ScopeDescription = CultureHelper.GetTraduction(m.Scope.ToString(), "Spartan_BR_Scope", string.Empty, "Description") ?? (string)m.Scope_Spartan_BR_Scope.Description
        ...
        public ActionResult GetSpartan_BR_Conditions_Detail_Spartan_BR_Condition_OperatorAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.ConditionOperatorId), "Spartan_BR_Condition_Operator", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_Conditions_Detail_Spartan_BR_Operator_TypeAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.OperatorTypeId), "Spartan_BR_Operator_Type", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_Conditions_Detail_Spartan_BR_ConditionAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.ConditionId), "Spartan_BR_Condition", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_Actions_True_Detail_Spartan_BR_Action_ClassificationAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.ClassificationId), "Spartan_BR_Action_Classification", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_Actions_True_Detail_Spartan_BR_ActionAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.ActionId), "Spartan_BR_Action", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_Actions_True_Detail_Spartan_BR_Action_ResultAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.ActionResultId), "Spartan_BR_Action_Result", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_Operation_Detail_Spartan_BR_OperationAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.OperationId), "Spartan_BR_Operation", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        [HttpGet]
        public ActionResult GetSpartan_BR_Process_Event_Detail_Spartan_BR_Process_EventAll(int Attribute)
        {
            try
            {
                if (!_tokenManager.GenerateToken())
                ...
                string where = "Spartan_BR_Process_Event.Attribute = " + Attribute;
                if (Attribute > 10)
                {
                ...
                return Json(new
                {
                    ...
                    ,
                        Description = CultureHelper.GetTraduction(m.ProcessEventId.ToString(), "Spartan_BR_Process_Event", string.Empty, "Description") ?? m.Description
        ...
        public ActionResult GetSpartan_BR_Peer_Review_Spartan_BR_Rejection_ReasonAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.Key_Rejection_Reason), "Spartan_BR_Rejection_Reason", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetSpartan_BR_Scope_Detail_Spartan_BR_ScopeAll()
        {
            try
            {
                ...
                foreach (var item in result)
                {
                    item.Description = CultureHelper.GetTraduction(Convert.ToString(item.ScopeId), "Spartan_BR_Scope", string.Empty, "Description") ?? item.Description;
                }
                return Json(result.ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetConditionsList()
        {
            ...
            return Json(new
            {
                ...
                ,
                    Description = CultureHelper.GetTraduction(m.ConditionId.ToString(), "Spartan_BR_Condition", string.Empty, "Description") ?? m.Description
        ...
        public ActionResult GetOperatorTypesList()
        {
            ...
            return Json(new
            {
                ...
                ,
                    Description = CultureHelper.GetTraduction(m.OperatorTypeId.ToString(), "Spartan_BR_Operator_Type", string.Empty, "Description") ?? m.Description
        ...
        public ActionResult GetConditionOperatorList()
        {
            ...
            return Json(new
            {
                ...
                ,
                    Description = CultureHelper.GetTraduction(m.ConditionOperatorId.ToString(), "Spartan_BR_Condition_Operator", string.Empty, "Description") ?? m.Description
        ...
        public ActionResult GetActionClassificationList()
        {
            ...
            return Json(new
            {
                ...
                ,
                    Description = CultureHelper.GetTraduction(m.ClassificationId.ToString(), "Spartan_BR_Action_Classification", string.Empty, "Description") ?? m.Description
        ...
        public ActionResult GetActionResultList()
        {
            ...
            return Json(new
            {
                ...
                ,
                    Description = CultureHelper.GetTraduction(m.ActionResultId.ToString(), "Spartan_BR_Action_Result", string.Empty, "Description") ?? m.Description
        ...
        public ActionResult GetActionListByClassification(int classificationId)
        {
            ...
            return Json(new
            {
                aaData = result.Spartan_BR_Actions.Select(m => new Spartan_BR_ActionGridModel
                {
                    ActionId = m.ActionId
                ,
                    Description = CultureHelper.GetTraduction(m.ActionId.ToString(), "Spartan_BR_Action",m.Description, "Description") ?? m.Description
        ...
        public ActionResult GetSpartan_BR_StatusList()
        {
            ...
            return Json(new
            {
                aaData = result.Spartan_BR_Statuss.Select(m => new Spartan_BR_StatusGridModel
                {
                    StatusId = m.StatusId
                ,
                    Description = CultureHelper.GetTraduction(m.StatusId.ToString(), "Spartan_BR_Status", m.Description,"Description") ?? m.Description
